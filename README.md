...
With the certificates generated by Local CA, you can add HTTPs to your local instances Proxmox, Adguard Home, Pi-Hole, Jellyfin, Grafana, Homepage, Bitwarden etc. 

<img src="screenshots/localca-1.1.1.png" alt="Alt Text" width="70%" height="70%">
...
<img src="screenshots/localca-1.1.2.png" alt="Alt Text" width="70%" height="70%"> 
Create Root CA page

<img src="screenshots/localca-1.1.3.png" alt="Alt Text" width="70%" height="70%">
